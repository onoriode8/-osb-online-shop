...
const WatchCheckout = (props) => {
    ...
    const placeOrderOnWatchHandler = async (event) => {
        ...
        <React.Fragment>
            ...
            <div>
                <ErrorCard error={error} errorDisplay={errorDisplay}
                 errorDisplayHandler={() => setErrorDisplay(false)} />
            </div>
            {/* <div style={{marginTop: "4em"}} onClick={()=>props.history.goBack()}>back</div> */}
            ...
            <div>
                ...
                <Card>
                    ...
                    <form>
                        <Button click={placeOrderOnWatchHandler} disabled={inputChange}>CONFIRM ORDER</Button>
                    </form>
                </Card>
            </div>
        </React.Fragment>
...
const mapStateToProps = state => {
    return {
        deliveryFee: state.shopListReducer.watchData.deliveryFee
    }
};

export default connect(mapStateToProps)(WatchCheckout);