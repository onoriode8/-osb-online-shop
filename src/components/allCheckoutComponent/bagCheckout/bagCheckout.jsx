...
const BagCheckout = (props) => {
    ...
    const placeOrderOnBagHandler = async (event) => {
        ...
        <React.Fragment>
            ...
            <div>
                ...
                <Card>
                    ...
                    <form>
                        <Button click={placeOrderOnBagHandler} disabled={inputChange}>CONFIRM ORDER</Button>
                    </form>
                </Card>
            </div>
        </React.Fragment>
...
const mapStateToProps = state => {
    return {
        deliveryFee: state.shopReducer.bagData.deliveryFee
    }
};

export default connect(mapStateToProps)(BagCheckout);