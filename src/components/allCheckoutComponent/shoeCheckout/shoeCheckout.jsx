...
const ShoeCheckout = (props) => {
    ...
    const placeOrderOnShoeHandler = async (event) => {
        ...
        <React.Fragment>
            ...
            <div>
                ...
                <Card>
                    ...
                    <form>
                        <Button click={placeOrderOnShoeHandler} disabled={inputChange}>CONFIRM ORDER</Button>
                    </form>
                </Card>
            </div>
        </React.Fragment>
...
const mapStateToProps = state => {
    return {
        deliveryFee: state.shopListReducer.shoeData.deliveryFee
    }
};

export default connect(mapStateToProps)(ShoeCheckout);