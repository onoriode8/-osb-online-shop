...
const BlenderCheckout = (props) => {
    ...
    const placeOrderOnBlenderHandler = async (event) => {
        ...
        <React.Fragment>
            ...
            <div>
                ...
                <Card>
                    ...
                    <form>
                        <Button click={placeOrderOnBlenderHandler} disabled={inputChange}>CONFIRM ORDER</Button>
                    </form>
                </Card>
            </div>
        </React.Fragment>
...
const mapStateToProps = state => {
    return {
        deliveryFee: state.shopReducer.blenderData.deliveryFee
    }
};

export default connect(mapStateToProps)(BlenderCheckout);