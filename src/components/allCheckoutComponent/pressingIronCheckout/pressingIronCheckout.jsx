...
const PressingIronCheckout = (props) => {
    ...
    const placeOrderOnPressingIronHandler = async (event) => {
        ...
        const data = {
            ...
            total: quanty,
            image: cartData[0].pressingIronImage
        }
        try {
        ...
        <React.Fragment>
            ...
            <div>
                ...
                <Card>
                    ...
                    <form>
                        <Button click={placeOrderOnPressingIronHandler} disabled={inputChange}>CONFIRM ORDER</Button>
                    </form>
                </Card>
            </div>
        </React.Fragment>
...
const mapStateToProps = state => {
    return {
        deliveryFee: state.shopReducer.pressingIronData.deliveryFee
    }
};

export default connect(mapStateToProps)(PressingIronCheckout);