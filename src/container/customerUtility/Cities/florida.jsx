...
const styles = {
 ...
 const Florida = (props) => {
    const [FloridaCity, setFloridaCity] = useState();
    ...
    useEffect(() => {
        ...
        const Location = { LocationState: props.type, LocationCity: FloridaCity };
        setTimeout(() => {
...
export default connect(null, mapDispatchToProps)(Florida);